...
var shoulder_direction_bone_names = [][]string{
	{
		pmx.NECK_ROOT.String(), pmx.SHOULDER_ROOT.Left(), pmx.SHOULDER_P.Left(), pmx.SHOULDER.Left(), pmx.ARM.Left(),
	},
	{
		pmx.NECK_ROOT.String(), pmx.SHOULDER_ROOT.Right(), pmx.SHOULDER_P.Right(), pmx.SHOULDER.Right(), pmx.ARM.Right(),
	},
}
